                ...
                if(tfod != null) {
                    ...
                    if(updatedRecognitions != null) {
                        ...
                        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startingPose)
                                ...
                                .splineTo(new Vector2d(-2, -4), Math.toRadians(90))
                                ...
                                .resetVelConstraint()
                                .back(35)
                                .splineTo(new Vector2d(18, -12), Math.toRadians(330))
                                .UNSTABLE_addTemporalMarkerOffset(-3, () -> drive.liftMotor.setPower(1))
                                .addTemporalMarker(() -> drive.liftMotor.setPower(0))
                                .back(7)
                                .addTemporalMarker(() -> drive.output.setPosition(1))
                                .waitSeconds(1)
