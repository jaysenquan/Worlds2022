                ...
                if(tfod != null) {
                    ...
                    if(updatedRecognitions != null) {
                        ...
                        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startingPose)
                            ...
                            .splineTo(new Vector2d(4, 5), Math.toRadians(270))
                            .UNSTABLE_addTemporalMarkerOffset(-lowerTime, () -> drive.liftMotor.setPower(-1))
                            .addTemporalMarker(() -> drive. liftMotor.setPower(0))
                            .setVelConstraint(getVelocityConstraint(MAX_VEL/3.25, MAX_ANG_VEL, TRACK_WIDTH))
                            .forward(25)
                            .UNSTABLE_addTemporalMarkerOffset(-lowerTime, () -> drive.liftMotor.setPower(-1))
                            .build();

                        drive.followTrajectorySequence(trajSeq);
                        commands.turnCarousel(1);
                        commands.strafeToPosition(26, .4, 1);
